# Runs elevated: closes any running copy and starts dist\Crescendo-Setup.exe
...
Start-Process "D:\Crescendo\dist\Crescendo-Setup.exe" -ArgumentList "/SILENT /SUPPRESSMSGBOXES /NORESTART /LOG=`"$env:ProgramData\Crescendo\inno.log`""
